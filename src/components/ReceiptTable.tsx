      ...
      <table className="w-full min-w-full table-auto text-sm text-slate-900">
        <thead className="border-b border-slate-200 text-left text-slate-700">
          <tr>
            ...
            <th className="whitespace-nowrap px-3 py-3">Purchase price</th>
          ...
          {rows.map((row) => (
            ...
            >
              <td className="whitespace-nowrap px-3 py-3">
                <span className="rounded-lg px-2 py-1 text-slate-900">{row.item || "-"}</span>
              </td>
              <td className="whitespace-nowrap px-3 py-3">{row.purchaseDate || "-"}</td>
              <td className="whitespace-nowrap px-3 py-3">{row.platform || "-"}</td>
              <td className="whitespace-nowrap px-3 py-3">
                {row.purchasePrice ? formatSek(Number(row.purchasePrice) || 0) : "-"}
              </td>
              <td className="whitespace-nowrap px-3 py-3">
                {row.totalPrice ? formatSek(Number(row.totalPrice) || 0) : "-"}
              </td>
              <td className="whitespace-nowrap px-3 py-3">
                <span
              ...
              <td className="whitespace-nowrap px-3 py-3">{row.soldDate || "-"}</td>
              <td className="whitespace-nowrap px-3 py-3">{row.soldPrice || "-"}</td>
              <td className="whitespace-nowrap px-3 py-3">
