...
export default function ReceiptFormModal({
  ...
  const [draft, setDraft] = useState<ReceiptRow>(initialRow ?? createEmptyRow());
  ...
  const validate = () => {
    ...
    if (!draft.item.trim()) nextErrors.item = "Item is required.";
    const purchasePrice = Number(draft.purchasePrice);
    if (!draft.purchasePrice.trim() || Number.isNaN(purchasePrice) || purchasePrice <= 0) {
      nextErrors.purchasePrice = "Purchase price must be greater than 0.";
    }
    if (draft.sold && !draft.soldDate.trim()) nextErrors.soldDate = "Sold date is required.";
    const soldPrice = Number(draft.soldPrice);
    if (
      draft.sold &&
      (!draft.soldPrice.trim() || Number.isNaN(soldPrice) || soldPrice <= 0)
    ) {
    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="space-y-1 text-sm text-slate-700">
          ...
          />
          <p className="min-h-4 text-xs font-medium text-rose-600">{errors.seller ?? ""}</p>
        </label>
        <label className="space-y-1 text-sm text-slate-700">
          Payment method
          <input
            ...
            className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-900"
          />
          <p className="min-h-4 text-xs font-medium text-rose-600">{errors.paymentMethod ?? ""}</p>
        </label>
        <label className="space-y-1 text-sm text-slate-700">
          Item
          <input
            ...
            className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-900"
          />
          <p className="min-h-4 text-xs font-medium text-rose-600">{errors.item ?? ""}</p>
        </label>
        <label className="space-y-1 text-sm text-slate-700">
          Platform
          <input
            ...
            className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-900"
          />
          <p className="min-h-4 text-xs font-medium text-rose-600">{errors.platform ?? ""}</p>
        </label>
        <label className="space-y-1 text-sm text-slate-700">
          Purchase date
          <input
        ...
        <label className="space-y-1 text-sm text-slate-700">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-900"
          />
          <p className="min-h-4 text-xs font-medium text-rose-600">{errors.itemPrice ?? ""}</p>
        </label>
        <label className="space-y-1 text-sm text-slate-700">
          ...
          <input
            ...
            onChange={(event) => updateField("buyerProtectionFee", event.target.value)}
            placeholder="0.00"
            className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-900"
          />
          <p className="min-h-4 text-xs font-medium text-rose-600">{errors.buyerProtectionFee ?? ""}</p>
        </label>
        <label className="space-y-1 text-sm text-slate-700">
          Shipping (kr)
          <input
            ...
            className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-900"
          />
          <p className="min-h-4 text-xs font-medium text-rose-600">{errors.shipping ?? ""}</p>
        </label>
      </div>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          <label className="space-y-1 text-sm text-slate-700">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-900"
            />
            <p className="min-h-4 text-xs font-medium text-rose-600">{errors.soldDate ?? ""}</p>
          </label>
          <label className="space-y-1 text-sm text-slate-700">
            Sold price (kr)
            <input
          ...
          <label className="space-y-1 text-sm text-slate-700 sm:col-span-2">
            ...
            <input
              ...
              onChange={(event) => updateField("soldPlatform", event.target.value)}
              className="w-full rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-900"
            />
            <p className="min-h-4 text-xs font-medium text-rose-600">
              {errors.soldPlatform ?? ""}
